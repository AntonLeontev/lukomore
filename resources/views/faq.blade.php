...
@section('title', 'Часто задаваемые вопросы и ответы для родителей')
@section('description', 'Узнайте ответы на самые частые вопросы о нашем частном детском саду. Вся информация о программе, питании, безопасности и многом другом. Поможем вам сделать правильный выбор для вашего ребенка!')
