...
@section('description')
	Читайте полезные статьи о воспитании детей в блоге частного детского сада «Лукоморье». Наш сад расположен в Центральном районе Санкт-Петербурга , на улице Маяковского, 37 В (метро «Чернышевская»).
@endsection
