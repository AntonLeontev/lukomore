...
@section('title', 'Сбалансированное питание в частном детском саде «Лукоморье»: меню, рацион')
@section('description', 'Вкусное и полезное четырехразовое питание для детей в частном садике «Лукоморье», который расположен в Центральном районе Санкт-Петербурга. Звоните +7 (929) 109-08-08!')
