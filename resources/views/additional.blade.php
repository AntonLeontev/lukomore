...
@section('title', 'Дополнительные занятия в детском саду «Лукоморье»')
@section('description', 'В нашем детском саду вас ждут дополнительные занятия по английскому языку, робототехнике, музыке, уроки живописи и многое другое. Звоните +7 (929) 109-08-08!')
