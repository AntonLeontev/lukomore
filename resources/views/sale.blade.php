...
@section('title', 'Акции и специальные предложения в частном детском саду «Лукоморье»')
@section('description', 'Узнайте о текущих акциях и специальных предложениях в частном детском саду «Лукоморье». Скидки, бонусы и уникальные условия для новых и постоянных клиентов. Заботьтесь о будущем вашего ребенка с нами!')
